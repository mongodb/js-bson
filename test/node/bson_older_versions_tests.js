...
describe('Mutual version and distribution compatibility', function () {
  ...
  const makeObjects = bson => [
    ...
    new bson.MinKey(),
    new bson.MaxKey(),
    // TODO(NODE-4843): Timestamp has a necessary incompatibility, two number ctor throws now -- new bson.Timestamp(1, 100),
    new bson.Timestamp(new bson.Long(1, 100, true)),
    new bson.Code('abc'),
