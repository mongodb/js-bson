...
## [7.0.0](https://github.com/mongodb/js-bson/compare/v6.0.1...v7.0.0) (2024-05-07)
...
* **NODE-4892:** error on bson types not from this version ([#543](https://github.com/mongodb/js-bson/issues/543))
* **NODE-4890:** make all thrown errors into BSONErrors ([#545](https://github.com/mongodb/js-bson/issues/545))
* **NODE-4713:** modernize bundling ([#534](https://github.com/mongodb/js-bson/issues/534))
* **NODE-1921:** validate serializer root input ([#537](https://github.com/mongodb/js-bson/issues/537))
* **NODE-4711:** remove evalFunctions option ([#539](https://github.com/mongodb/js-bson/issues/539))
* **ObjectId:** 
...
* add support for primitives to EJSON.stringify ([329857d](https://github.com/mongodb/js-bson/commit/329857d0e7ccdaa5738716907eae4eeeac6b2bda))
* **BSON:** simplify and flatten module exports ([f8920c6](https://github.com/mongodb/js-bson/commit/f8920c68aaa986595db04b9915301bf0e38139a2))
* **bson:** test bson in browser ([223fbdf](https://github.com/mongodb/js-bson/commit/223fbdf229088402fe9c625a72c4adff71d7e6a8))
* **bsontype:** move all `_bsontypes` to non-enumerable properties ([16f5bf6](https://github.com/mongodb/js-bson/commit/16f5bf6156b1089b05c50741fab1757f16946a20))
...
* **db-ref:** support passing a namespace into a DBRef ctor ([604831b](https://github.com/mongodb/js-bson/commit/604831b492479ab381dcdf80cbe6fb69537a9d59))
* **ext-json:** add extended JSON codecs directly to BSON types ([10e5f00](https://github.com/mongodb/js-bson/commit/10e5f005e69af242967c25c8d101fb61166f0ee2))
* **ext-json:** add extended JSON support to the bson library ([d6b71ab](https://github.com/mongodb/js-bson/commit/d6b71ab432fb523668e9fc03937b3c5f65f6ae5f))
* **ext-json:** export EJSON at top level of module ([c356a5a](https://github.com/mongodb/js-bson/commit/c356a5a34902931df985f97b1e554bd53bb20843))
...
* **karma:** test bson in the browser ([cd593ca](https://github.com/mongodb/js-bson/commit/cd593ca605e3a306d607e14b64528dd4567095aa))
* **long:** replace long implementatin with long.js ([545900d](https://github.com/mongodb/js-bson/commit/545900d07ab2d8e06c542a2683d95c874077c715))
...
* **ObjectID:** use FNV-1a hash for objectId ([4f545b1](https://github.com/mongodb/js-bson/commit/4f545b1e334895344d6163774a2aa3b368285eb5))
* **rollup:** initial commit of rollup-generated bundle ([474b8f7](https://github.com/mongodb/js-bson/commit/474b8f7c8050a490d92a79eeeca087f60620a6b1))
* **rollup:** switch from webpack to rollup for bundling ([98068fa](https://github.com/mongodb/js-bson/commit/98068fa5b755d9f37b69f9d4dfe63b7a5777f600))
* **serialization:** support arbitrary sizes for the internal serialization buffer ([a6bd45c](https://github.com/mongodb/js-bson/commit/a6bd45c3f014d21639c99fa46bb1ba92556242b5))
* **UintArray:** Adds support for Uint8Arrays ([2a54053](https://github.com/mongodb/js-bson/commit/2a54053b7e2bda99e812ce7bb928db43c41ba3e0))
...
* 4.x-1.x interop (incl. ObjectID _bsontype) ([f4b16d9](https://github.com/mongodb/js-bson/commit/f4b16d91e969508c6b77b7e1f7b62bc2bc37b126))
...
* **binary:** add type checking for buffer ([cbfb25d](https://github.com/mongodb/js-bson/commit/cbfb25d36823708cecbcbc9c681557b88feb5fba))
* **browser:** fixing browser property in package.json ([095fba9](https://github.com/mongodb/js-bson/commit/095fba9ec97c71c2c4c20f2da9c0b188c13f889b))
* **bson:** normalizedFunctionString handles named functions ([6b49c23](https://github.com/mongodb/js-bson/commit/6b49c233ddda1e09e969fd6aedc95466081ff610))
* **buffer:** don't use deprecated Buffer constructors ([7bb9c57](https://github.com/mongodb/js-bson/commit/7bb9c57db1c5f862dee4762fd2211e2a722cb75d))
* **Buffer:** import buffer for binary, decimal128, and fnv1a ([6be7b8d](https://github.com/mongodb/js-bson/commit/6be7b8de60d3e1f060cbfb8d5829aa3515e6e6db))
* **buffer:** replace deprecated Buffer constructor ([5acdebf](https://github.com/mongodb/js-bson/commit/5acdebf7a63ed02d3bc1eb8481cdcb709fb5c886))
...
* **dbPointer:** fix utf8 bug for dbPointer ([018c769](https://github.com/mongodb/js-bson/commit/018c76939bfd663b185757b5f6fbed5ffca61327))
* **dbref:** only upgrade objects with allowed $keys to DBRefs ([98eb9e2](https://github.com/mongodb/js-bson/commit/98eb9e22353e300824b7aed777b554eddb2676ce))
* **decimal128:** add basic guard against REDOS attacks ([511ecc4](https://github.com/mongodb/js-bson/commit/511ecc487ea57f554a0d199206a58efbc9cd121c))
* **Decimal128:** update toString and fromString methods to correctly handle the case of too many significant digits ([25ed43e](https://github.com/mongodb/js-bson/commit/25ed43ed25a19be5ba873b4f9efb36081ad6d857))
* deprecate cacheFunctionsCrc32 ([ea83bf5](https://github.com/mongodb/js-bson/commit/ea83bf5200f4a936692f710063941ba802386da4))
* **deserialize:** fix deserialization of 0xFFFD ([c682ae3](https://github.com/mongodb/js-bson/commit/c682ae3997987b2bf6be0195972140d005d8410f)), closes [#277](https://github.com/mongodb/js-bson/issues/277)
* **deserializer:** corrected the check for (size + index) comparision to buffer.length ([6dadd4b](https://github.com/mongodb/js-bson/commit/6dadd4bde837ee249d8b45cc74ba9a83519f1c5a))
* **deserializeStream:** allow multiple documents to be deserialized ([6fc5984](https://github.com/mongodb/js-bson/commit/6fc5984a46f228a72ab5bf10039ff7cf528093ed)), closes [#244](https://github.com/mongodb/js-bson/issues/244)
...
* **ejson-serialize:** prevent double serialization for nested documents ([ab790c9](https://github.com/mongodb/js-bson/commit/ab790c9b3765a1500a5137d6f9062f632cba9108))
* **ejson:** enable serialization of legacy `ObjectID` ([ba98ccb](https://github.com/mongodb/js-bson/commit/ba98ccb432a389f2fddfd75170cd2fc0a326b06e))
* **ejson:** support array for replacer parameter in `EJSON.stringify` ([9f43809](https://github.com/mongodb/js-bson/commit/9f4380927254290227cda8d5db3a08809b6ce3d6))
* **ext-json:** deserialize doubles as `Number` in relaxed mode ([a767fa1](https://github.com/mongodb/js-bson/commit/a767fa1ff815e105e1693268d6d6073102bf2000))
...
* improve EJSON generation for previously skipped edge cases ([30f5a8f](https://github.com/mongodb/js-bson/commit/30f5a8f8ca2ffdf7fc36b451b52ebfe5757a837e))
...
* make sure all functions are named consistently ([6df9022](https://github.com/mongodb/js-bson/commit/6df9022174c74637d5c390506ee71c5b28c4c7a7))
...
* **NODE-4464:** stringify and parse negative zero to and from $numberDouble: -0.0 ([#531](https://github.com/mongodb/js-bson/issues/531)) ([a469e91](https://github.com/mongodb/js-bson/commit/a469e919bbee8704d0bbc18d435d7a4d27f65027))
...
* **object-id:** correct serialization of old ObjectID types ([8d57a8c](https://github.com/mongodb/js-bson/commit/8d57a8c92d87f7151117ae3cc6cb3acd577996ac))
* **object-id:** harden the duck-typing ([4b800ae](https://github.com/mongodb/js-bson/commit/4b800aed754e9589f884ca6ee6184b5b6ab665f1))
* **objectid:** if pid is 1, use random value ([e188ae6](https://github.com/mongodb/js-bson/commit/e188ae6cacf81d729b73ba94a5b55d41ed9ce625))
* **ObjectID:** ObjectId.isValid should check buffer length ([06af813](https://github.com/mongodb/js-bson/commit/06af8130fb20ae4ab3968e51281ebfae40a46dd3))
* **ObjectId:** will now throw if an invalid character is passed ([6f30b4e](https://github.com/mongodb/js-bson/commit/6f30b4ec0dbba5a5e8eeca2c937d50838be7853d))
* only upgrade `symbol` to `string` if `promoteValues` is true ([067a7ba](https://github.com/mongodb/js-bson/commit/067a7ba75b2900306b027200d870ed85745c377e))
* **package:** `browser` section needs to point to correct index ([08337e3](https://github.com/mongodb/js-bson/commit/08337e3a43a294842ed92f82da3b5856e49d7dc5))
* parse value of Int32 in constructor ([5cda40f](https://github.com/mongodb/js-bson/commit/5cda40f678795117b237052c0e9ab38d0cb8b684))
...
* **random-bytes:** fallback to insecure path if require is null ([963b12b](https://github.com/mongodb/js-bson/commit/963b12b902860fcb1abedc1f3976c1eb9893b45c))
* **random-bytes:** wrap crypto require in try/catch for fallback ([47fd5f7](https://github.com/mongodb/js-bson/commit/47fd5f741a0b058770f5cf4fb3b966e5f9eb7adf))
* **readme:** clarify documentation about deserialize methods ([e311056](https://github.com/mongodb/js-bson/commit/e31105610b7b77bde4eb8ed03c1a2e80dbcf50f0))
* Reduce floating point precision required of extended json implementations ([#369](https://github.com/mongodb/js-bson/issues/369)) ([5e35d1a](https://github.com/mongodb/js-bson/commit/5e35d1a4e96b13368eeced4d87f60bdb2c0d1562))
* **regexp:** properly construct new BSONRegExp when constructor called without new ([#242](https://github.com/mongodb/js-bson/issues/242)) ([93ae799](https://github.com/mongodb/js-bson/commit/93ae799bc6c01df4f7dfcadb2ce6cc58a3cbe13c))
...
* **revert:** Reverting v3.0.1 ([efb0720](https://github.com/mongodb/js-bson/commit/efb0720fbcc146c07040c66bf1f5682eaf9b16c0))
...
* **rollup:** fixup dist and bundle in Buffer ([3620ef8](https://github.com/mongodb/js-bson/commit/3620ef899289a544cba958593ab8695a6b80475d))
* **serialization:** normalize function stringification ([21eb0b0](https://github.com/mongodb/js-bson/commit/21eb0b0aacd759681e8e9a620c7f77f7651047e8))
* **serializer:** do not use checkKeys for $clusterTime ([cbb4724](https://github.com/mongodb/js-bson/commit/cbb472417d9d07920df739acf0ed4c1d8a10c345))
* **serializer:** ensure RegExp options are alphabetically sorted ([d60659d](https://github.com/mongodb/js-bson/commit/d60659def1032a436c1779ad17d0bff16f997b80))
* **serializer:** map insert expects only string keys ([aba3a18](https://github.com/mongodb/js-bson/commit/aba3a18552b66d5920523733ee8e086909ec8aaa))
* **serializeWithBufferAndIndex:** write documents to start of intermediate buffer ([b4e4ac5](https://github.com/mongodb/js-bson/commit/b4e4ac5d1af138a9896daa382b62a36bf0dc32af))
* spelling in deserializer errors ([4c6f2e4](https://github.com/mongodb/js-bson/commit/4c6f2e4f7f39e75274dd12e67d34befb4fd6ea28))
* support Number object in Int32 and Double constructors ([fe3f0dc](https://github.com/mongodb/js-bson/commit/fe3f0dcb1aae0b7c22232afe2e05e040e3aba741))
...
* **timestamp:** getTimestamp support times beyond 2038 ([a0820d5](https://github.com/mongodb/js-bson/commit/a0820d51ed1b759e0cfc362f0fce3bc7a0e82cb0))
* **Timestamp:** make sure timestamp is always unsigned ([36b2d43](https://github.com/mongodb/js-bson/commit/36b2d4301a3b1f392fea0933419d0cea961f49e1))
...
* **NODE-4194:** improve objectId constructor performance ([#498](https://github.com/mongodb/js-bson/issues/498)) ([be5fe3e](https://github.com/mongodb/js-bson/commit/be5fe3e105302369950c35b599e0a4d018411506))
* **NODE-4726:** bench many strings in large batch in parallel ([#516](https://github.com/mongodb/js-bson/issues/516)) ([62c7977](https://github.com/mongodb/js-bson/commit/62c7977806d3a94fd902ad43b015e5a476e9ea4d))
...
* **symbol:** rename Symbol to BSONSymbol ([5d5b3d2](https://github.com/mongodb/js-bson/commit/5d5b3d25973c122a675c9cf4cadf8cf514fe4cbb))
