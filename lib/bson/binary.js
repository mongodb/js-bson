...
let atob = require('./shared').atob,
  btoa = require('./shared').btoa;
...
Binary.prototype.toJSON = function() {
  if (this.buffer instanceof Uint8Array) return btoa(String.fromCharCode.apply(null, this.buffer));
...
Binary.fromBase64 = function(input) {
  return atob(input);
};

Binary.prototype.toBase64 = Binary.prototype.toJSON;
