...
/**
* Performs String.indexOf on the 24 byte hex string representation.
*
* @return {String} return indexOf on the 24 byte hex string representation.
* @api private
*/
ObjectID.prototype.indexOf = function(searchValue, fromIndex) {
  return this.toHexString().indexOf(searchValue, fromIndex);
};
