...
Decimal128.fromString = function(string) {
  ...
  var readDigits = function(string, index, exponent) {
    var start = index;

    while(true) {
      if(isDigit(string[index])) {
        exponent.push(string[index++]);
      } else {
        return (index - start);
      }
    }
  ...
  if(string[index] == 'e' || string[index] == 'E') {
    // Read all the digits
    var readExponent = readDigits(string, ++index, exponent);
    // Adjust the index
    index = index + readExponent;
  ...
  // console.log("========================= dec ")
  // console.dir(dec)
  // console.log(" number: " + dec.low.toString())
  // console.log(" number: " + dec.high.toString())
