...
BSON.prototype.serialize = function serialize(object, checkKeys, asBuffer, serializeFunctions, index) {
	var finishedBuffer = new Buffer(serializer(this.buffer, object, checkKeys, index || 0, 0, serializeFunctions));
...
BSON.prototype.serializeWithBufferAndIndex = function(object, checkKeys, buffer, startIndex, serializeFunctions) {
	var index = serializer(this.buffer, object, checkKeys, 0, 0, serializeFunctions);
	this.buffer.copy(buffer, startIndex, 0, index);
